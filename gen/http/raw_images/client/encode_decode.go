...
// object with method and path set to call the "Raw images" service "Load new
...
func (c *Client) BuildLoadNewProcessedSatelliteImageRequest(ctx context.Context, v interface{}) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: LoadNewProcessedSatelliteImageRawImagesPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("Raw images", "Load new processed satellite image", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// sent to the Raw images Load new processed satellite image server.
func EncodeLoadNewProcessedSatelliteImageRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*rawimages.ProcessedSatelliteImage)
		if !ok {
			return goahttp.ErrInvalidType("Raw images", "Load new processed satellite image", "*rawimages.ProcessedSatelliteImage", v)
		}
		body := NewLoadNewProcessedSatelliteImageRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("Raw images", "Load new processed satellite image", err)
		}
		return nil
	}
}
...
// returned by the Raw images Load new processed satellite image endpoint.
// restoreBody controls whether the response body should be restored after
// having been read.
...
func DecodeLoadNewProcessedSatelliteImageResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusBadRequest:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("Raw images", "Load new processed satellite image", err)
			}
			err = ValidateLoadNewProcessedSatelliteImageBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("Raw images", "Load new processed satellite image", err)
			}
		...
		default:
			body, _ := ioutil.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("Raw images", "Load new processed satellite image", resp.StatusCode, string(body))
		}
	}
}

// marshalRawimagesGeographicInformationToGeographicInformationRequestBody
// builds a value of type *GeographicInformationRequestBody from a value of
// type *rawimages.GeographicInformation.
func marshalRawimagesGeographicInformationToGeographicInformationRequestBody(v *rawimages.GeographicInformation) *GeographicInformationRequestBody {
	if v == nil {
		return nil
	}
...
// marshalRawimagesNormalizedIndexesToNormalizedIndexesRequestBody builds a
// value of type *NormalizedIndexesRequestBody from a value of type
// *rawimages.NormalizedIndexes.
func marshalRawimagesNormalizedIndexesToNormalizedIndexesRequestBody(v *rawimages.NormalizedIndexes) *NormalizedIndexesRequestBody {
	if v == nil {
		return nil
	}
...
// marshalGeographicInformationRequestBodyToRawimagesGeographicInformation
// builds a value of type *rawimages.GeographicInformation from a value of type
// *GeographicInformationRequestBody.
func marshalGeographicInformationRequestBodyToRawimagesGeographicInformation(v *GeographicInformationRequestBody) *rawimages.GeographicInformation {
	if v == nil {
		return nil
	}
...
// marshalNormalizedIndexesRequestBodyToRawimagesNormalizedIndexes builds a
// value of type *rawimages.NormalizedIndexes from a value of type
// *NormalizedIndexesRequestBody.
func marshalNormalizedIndexesRequestBodyToRawimagesNormalizedIndexes(v *NormalizedIndexesRequestBody) *rawimages.NormalizedIndexes {
	if v == nil {
		return nil
	}
